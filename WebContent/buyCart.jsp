...
<body class="bodybgcolor">
	<%
		...
		String totalPrice=request.getParameter("totalInput");
		...
		<tr>
			<td align="center" valign="top">
				...
				<form method="post" autocomplete="off"
					...
					action="<%=request.getContextPath()%>/BuyCartProductsServlet">
					<table width="40%" border="1" cellpadding="1" cellspacing="0"
						...
						<tr>
							...
							<td><div id="totalPrice_info"><%=df.format(Double.parseDouble(totalPrice)) %></div></td>
						</tr>
						<tr>
							<td class="STYLE1">
						...
						<tr>
							...
							<td><input type="password" name="password" id="password" onclick="checkMoney()"
					...
					<p>
						<input type="hidden" name="uid" value=<%=user.getUid()%> /> <input
							...
							type="submit" name="Submit" value="确认购买"> <input
							type="reset" name="Reset" value="重 置">
					</p>
				</form>
			</td>
		</tr>
