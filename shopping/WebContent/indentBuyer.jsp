...
<body class="bodybgcolor">
		...
		<tr>
			<td align="center" valign="top">
				...
				<table class="stateTable">
					<tr>	
						<td><a href="indentBuyerSession.jsp"> <%
 ...
 %>
						...
						<td><a href="indentBuyerSession.jsp?state=待发货"> <%
 ...
 %>
						...
						<td><a href="indentBuyerSession.jsp?state=已发货"> <%
 ...
 %>
						...
						<td><a href="indentBuyerSession.jsp?state=交易成功"> <%
 ...
 %>
						...
						<td><a href="indentBuyerSession.jsp?state=退款中"> <%
 	if (stateSession != null && stateSession.equals("退款中")) {
 %><font color="#95b9ea">退款中</font> <%
 	} else {
 %>退款中<%
 	}
 %>
						</a></td>
						<td><a href="indentBuyerSession.jsp?state=交易取消"> <%
 	if (stateSession != null && stateSession.equals("交易取消")) {
 %><font color="#95b9ea">交易取消</font> <%
 	} else {
 %>交易取消<%
 	}
 %>
				...
				<table width="80%" align="center">
					<tr>
						<td valign="top" bgcolor="#f2ffff">
							<div>
								<jsp:include page="indentBuyerProduct.jsp"></jsp:include>
							</div>
